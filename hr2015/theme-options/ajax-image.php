...
if (!function_exists('reedwan_ajax_image_upload') || !function_exists('reedwan_ajax_image_remove')) {
//Save image via AJAX
    add_action('wp_ajax_reedwan_ajax_upload', 'reedwan_ajax_image_upload'); //Add support for AJAX save

    function reedwan_ajax_image_upload() {
...
//Remove image via AJAX
    add_action('wp_ajax_reedwan_ajax_remove', 'reedwan_ajax_image_remove'); //Add support for AJAX save

    function reedwan_ajax_image_remove() {
        global $wpdb; //Now WP database can be accessed
