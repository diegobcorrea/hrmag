...
var pexetoButtons=[
		...
		{
			id:'pexetolistchecksmall',
			image:'check-small.png',
			title:'List Check Small',
			allowSelection:false,
			list:"bullet_check_small"
		},
		{
			id:'pexetolistcheckbig',
			image:'check-big.png',
			title:'List Check Big',
			allowSelection:false,
			list:"bullet_check_big"
		},
		{
			id:'pexetolistcheck',
			image:'check.png',
		...
		},
		{
			id:'pexetoscrollbar',
			image:'scrollbar.png',
			title:'Insert scrollbar',
			allowSelection:false,
			fields:[{id:'id', name:'ID scroll'},{id:'width', name:'Width (optional)'},{id:'height', name:'Height (optional)'},{id:'color', name:'Scrollbar color (optional)'}],
			generateHtml:function(obj){
			var shortcode = '[scrollbar';
			if(obj.id){
				shortcode+=' id="'+obj.id+'"';
			}
			if(obj.width){
				shortcode+=' width="'+obj.width+'"';
			}
			if(obj.height){
				shortcode+=' height="'+obj.height+'"';
			}
			if(obj.color){
				shortcode+=' color="'+obj.color+'"';
			}
			shortcode+=']PLACE YOUT TEXT HERE[/scrollbar]'
