	...
	<div id="page-main" class="page-content text-center">
		<div class="row small-collapse medium-collapse large-collapse ohidden">
			<div class="medium-10 large-8 medium-centered large-centered columns">
				<h1>Deseas unirte al equipo de HRmag.la</h1>
				<p>Cuéntanos como nos podrías ayudar a seguir mejorando y difundiendo el patinaje enviando un inbox por nuestro Fanpage en Facebook o via correo electrónico</p>
			</div>

			<div class="fb socbox push-2 medium-4 large-4 columns">
				<h3>Facebook</h3>
			...
			<div class="ml socbox push-2 medium-4 large-4 columns">
